  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const tableData = ref<TableItem[]>([
        { id: 1, name: '张三', date: '2023-01-01', address: '北京市朝阳区', status: '活跃' },
        { id: 2, name: '李四', date: '2023-01-02', address: '上海市浦东新区', status: '离线' },
        { id: 3, name: '王五', date: '2023-01-03', address: '广州市天河区', status: '活跃' },
        { id: 4, name: '赵六', date: '2023-01-04', address: '深圳市南山区', status: '离线' },
        { id: 5, name: '钱七', date: '2023-01-05', address: '杭州市西湖区', status: '活跃' },
        { id: 6, name: '孙八', date: '2023-01-06', address: '成都市武侯区', status: '离线' },
        { id: 7, name: '周九', date: '2023-01-07', address: '重庆市渝中区', status: '活跃' },
        { id: 8, name: '吴十', date: '2023-01-08', address: '南京市鼓楼区', status: '离线' },
        { id: 9, name: '郑十一', date: '2023-01-09', address: '武汉市江汉区', status: '活跃' },
        { id: 10, name: '王十二', date: '2023-01-10', address: '西安市雁塔区', status: '离线' }
      ]);
