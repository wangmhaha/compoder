...
;(() => {
        ...
        for (let n = f + 1; n < t.length; n++)
          if (((o = t.charCodeAt(n)), 92 === o)) n += 1
            ...
            if (59 === o && t.charCodeAt(n + 1) === e)
              throw new Error(
                `Unterminated string: ${
                  t.slice(r, n + 1) + String.fromCharCode(p)
                }`,
              )
            if (o === e)
              throw new Error(
                `Unterminated string: ${
                  t.slice(r, n) + String.fromCharCode(p)
                }`,
              )
          }
        u += t.slice(r, f + 1)
  ...
  function j(e, t, r = [], n = {}) {
    for (let o = 0; o < e.length; o++) {
      ...
      if ("rule" === a.kind || "at-rule" === a.kind)
        r.push(a), j(a.nodes, t, r, n), r.pop()
      else if ("context" === a.kind) {
        j(a.nodes, t, r, { ...n, ...a.context })
        continue
      }
      r.push(a),
        t(a, {
    ...
    function v(e, c, p = {}, h = 0) {
      if ("declaration" === e.kind) {
        if (
          ...
          return
        if (p.theme && "-" === e.property[0] && "-" === e.property[1]) {
          if ("initial" === e.value) return void (e.value = void 0)
          p.keyframes || a.get(c).add(e)
        }
        if (e.value.includes("var("))
          if (p.theme && "-" === e.property[0] && "-" === e.property[1])
            for (let t of g(e.value)) f.get(t).add(e.property)
          else t.trackUsedVariables(e.value)
        if ("animation" === e.property) for (let t of E(e.value)) s.add(t)
        2 & r && e.value.includes("color-mix(") && i.get(c).add(e), c.push(e)
      } else if ("rule" === e.kind)
        if ("&" === e.selector)
          for (let t of e.nodes) {
            let e = []
            v(t, e, p, h + 1), e.length > 0 && c.push(...e)
          }
        else {
          let t = { ...e, nodes: [] }
          for (let r of e.nodes) v(r, t.nodes, p, h + 1)
          t.nodes.length > 0 && c.push(t)
        }
      else if ("at-rule" === e.kind && "@property" === e.name && 0 === h) {
        ...
        if (1 & r) {
          ...
          n ? u.push(y(t, r ?? "initial")) : d.push(y(t, r ?? "initial"))
        }
        o.add(e.params)
        let t = { ...e, nodes: [] }
        for (let r of e.nodes) v(r, t.nodes, p, h + 1)
        ...
        "@keyframes" === e.name && (p = { ...p, keyframes: !0 })
        let t = { ...e, nodes: [] }
        for (let r of e.nodes) v(r, t.nodes, p, h + 1)
        "@keyframes" === e.name && p.theme && l.add(t),
          (t.nodes.length > 0 ||
            "@layer" === t.name ||
            "@charset" === t.name ||
            "@custom-media" === t.name ||
        ...
        for (let t of e.nodes) v(t, c, { ...p, ...e.context }, h)
      } else "comment" === e.kind && c.push(e)
    }
    let w = []
    for (let t of e) v(t, w, {}, 0)
    e: for (let [e, r] of a)
      for (let n of r) {
        if (K(n.property, t.theme, f)) {
          if (n.property.startsWith(t.theme.prefixKey("--animate-")))
            for (let e of E(n.value)) s.add(e)
          continue
        }
        let r = e.indexOf(n)
      ...
      for (let [e, r] of i)
        for (let n of r) {
          ...
          if (
              ...
              if (
                (p(e.nodes, (e, { replaceWith: r }) => {
                  ...
                  let i = e,
                    ...
                    s = new Set()
                  do {
                    if ("function" !== i.kind || "var" !== i.value) return
                    let e = i.nodes[0]
            ...
            continue
          let i = { ...n, value: h(o) },
            l = b("@supports (color: color-mix(in lab, red, red))", [n])
          e.splice(r, 1, i, l)
        }
    if (1 & r) {
      let e = []
      if (
        ...
        w.splice(t < 0 ? w.length : t, 0, k("@layer", "properties", [])),
          w.push(
            b("@layer properties", [
              k(
                "@supports",
  ...
  var Y = {
    ...
    "line-width": function (e) {
      return R(e, " ").every(
        e => se(e) || ne(e) || "thin" === e || "medium" === e || "thick" === e,
      )
    },
    image: function (e) {
      let t = 0
  ...
  function G(e, t) {
    ...
    for (let r of t) if (Y[r]?.(e)) return r
    return null
  }
  var J = /^url\(.*\)$/
  function X(e) {
  ...
  var ke = /^-?[a-z][a-zA-Z0-9/%._-]*$/,
    ...
    xe = class {
      ...
      has(e, t) {
        return (
          this.utilities.has(e) && this.utilities.get(e).some(e => e.kind === t)
        )
      }
      get(e) {
    ...
    for (let n of t.nodes) {
      ...
      if (
        ...
        if ("named" === e.kind && "word" === n.kind) {
          if (!Ce.includes(n.value)) continue
  ...
  function Oe(e, t) {
    ...
    return (
      A(e, e => {
        if ("declaration" === e.kind && e.value && Ne.test(e.value))
          return (r |= 8), void (e.value = Fe(e.value, e, t))
        "at-rule" === e.kind &&
          ("@media" === e.name ||
            "@custom-media" === e.name ||
            "@container" === e.name ||
    ...
    let t = (function (e) {
        ...
        for (let [e, t] of [
          ...
          n(
            ...
            o(e, { themeKeys: ["--radius"], handle: e => t.map(t => y(t, e)) })
        n("border-solid", [
        ...
        n("text-left", [["text-align", "left"]]),
          ...
          o("align", { themeKeys: [], handle: e => [y("vertical-align", e)] }),
          t.functional("font", t => {
      ...
      r = (function (e) {
        ...
        r("first", ["&:first-child"]),
          ...
          t.functional("aria", (e, t) => {
            ...
            "arbitrary" === t.value.kind
              ? (e.nodes = [w(`&[aria-${Me(t.value.value)}]`, e.nodes)])
        ...
        let t = (function (e, t) {
          let r = (function (e, t) {
            if ("arbitrary" === e.kind) {
              let r = e.value
              return (
                e.modifier && (r = je(r, e.modifier, t.theme)),
          ...
          for (let o of r) {
            ...
            for (let r of e.variants)
              if (null === He(i, r, t.variants)) return []
      ...
      s = {
        ...
        getClassOrder(e) {
          return (function (e, t) {
            let { astNodes: r, nodeSorting: n } = Pe(Array.from(t), e),
  ...
  function Pe(e, t, { onInvalidCandidate: r } = {}) {
    let n = new Map(),
      o = [],
      a = new Map()
    for (let n of e) {
    ...
    for (; n.length > 0; ) {
      ...
      if ("declaration" === e.kind) {
        ...
        if ("--tw-sort" === e.property) {
          let r = qe.indexOf(e.value ?? "")
          if (-1 !== r) {
            t.add(r), (o = !0)
            continue
          }
        }
        let n = qe.indexOf(e.property)
        ;-1 !== n && t.add(n)
  ...
  function tt(e, { theme: t }, r) {
    ...
    if (Object.hasOwn(t, "fontFamily")) {
      let r = 5
      {
        let n = et(t.fontFamily.sans)
        n &&
          e.theme.hasDefault("--font-sans") &&
          (e.theme.add("--default-font-family", n, r),
          e.theme.add(
            "--default-font-feature-settings",
            et(t.fontFamily.sans, "fontFeatureSettings") ?? "normal",
            r,
          ),
          e.theme.add(
            "--default-font-variation-settings",
            et(t.fontFamily.sans, "fontVariationSettings") ?? "normal",
            r,
          ))
      }
      {
        let n = et(t.fontFamily.mono)
        n &&
          e.theme.hasDefault("--font-mono") &&
          (e.theme.add("--default-mono-font-family", n, r),
          e.theme.add(
            "--default-mono-font-feature-settings",
            et(t.fontFamily.mono, "fontFeatureSettings") ?? "normal",
            r,
          ),
          e.theme.add(
            "--default-mono-font-variation-settings",
            et(t.fontFamily.mono, "fontVariationSettings") ?? "normal",
            r,
          ))
      }
    }
  ...
  function nt(e) {
    ...
    for (let t of e) if (!rt.test(t)) return null
    return e
      ...
      let s = (() => {
        let o = at(n),
          [i, l] = (function (e, t) {
            ...
            let s = {},
              u = {}
            for (let [e, t] of n) ut(s, [e ?? "DEFAULT"], t)
            for (let [e, t] of i) ut(u, [e ?? "DEFAULT"], t)
        ...
        if (null !== s && "object" == typeof s && !Array.isArray(s)) {
          ...
          for (let t in i)
            "__CSS_VALUES__" !== t &&
              ((4 & s?.__CSS_VALUES__?.[t] && void 0 !== ct(e, t.split("-"))) ||
                (e[a(t)] = i[t]))
          return e
        }
  ...
  function gt(e, t, r = null) {
    for (let n = 0; n < e.length; n++) {
      ...
      if (a) 0 === l ? n-- : (n += i - 1)
        ...
        if (2 === l) return 2
        if (1 !== l && "function" === o.kind && 2 === gt(o.nodes, t, o))
          return 2
      }
    }
  }
    ...
    let a = {
      ...
      addVariant(t, r) {
        ...
        "string" == typeof r || Array.isArray(r)
          ...
          : "object" == typeof r && e.variants.fromAst(t, yt(r))
      },
      matchVariant(t, r, n) {
        function o(e, t, n) {
          return xt(r(e, { modifier: t?.value ?? null }), n)
        }
        ...
        for (let [t, r] of i)
          e.theme.prefix &&
            ...
            e.utilities.static(t, o => {
              ...
              return $t(a, t, o.raw), (n.current |= Je(a, e)), a
            })
      },
      matchUtilities(t, r) {
        ...
        for (let [a, i] of Object.entries(t)) {
          let t = function ({ negative: t }) {
            return l => {
              ...
              return $t(f, a, l.raw), (n.current |= Je(f, e)), f
            }
          }
          if (!kt.test(a))
            throw new Error(
  ...
  function yt(e) {
    ...
    for (let [e, n] of r)
      if ("object" != typeof n) {
        ...
        for (let r of n)
          "string" == typeof r ? t.push(y(e, r)) : t.push(b(e, yt(r)))
      else null !== n && t.push(b(e, yt(n)))
    return t
  }
  function xt(e, r) {
  ...
  var Tt = jt(e => {
    ...
    Ot = {
      ...
      aspectRatio: { auto: "auto", square: "1 / 1", video: "16 / 9", ...Vt },
      backdropBlur: ({ theme: e }) => e("blur"),
      backdropBrightness: ({ theme: e }) => ({ ...e("brightness"), ...Ct }),
      backdropContrast: ({ theme: e }) => ({ ...e("contrast"), ...Ct }),
      backdropGrayscale: ({ theme: e }) => ({ ...e("grayscale"), ...Ct }),
      backdropHueRotate: ({ theme: e }) => ({ ...e("hueRotate"), ...Et }),
      backdropInvert: ({ theme: e }) => ({ ...e("invert"), ...Ct }),
      backdropOpacity: ({ theme: e }) => ({ ...e("opacity"), ...Ct }),
      backdropSaturate: ({ theme: e }) => ({ ...e("saturate"), ...Ct }),
      backdropSepia: ({ theme: e }) => ({ ...e("sepia"), ...Ct }),
      ...
      divideWidth: ({ theme: e }) => ({ ...e("borderWidth"), ...St }),
      dropShadow: {
      ...
      outlineWidth: { 0: "0px", 1: "1px", 2: "2px", 4: "4px", 8: "8px", ...St },
      ...
      saturate: { 0: "0", 50: ".5", 100: "1", 150: "1.5", 200: "2", ...Ct },
      scale: {
        0: "0",
        50: ".5",
        75: ".75",
  ...
  function Ut(e, t) {
    ...
    let n = (function (e) {
      let t = new Set(),
        r = st(e.design, () => e.theme, o),
        n = Object.assign(r, { theme: r, colors: At })
      function o(e) {
  ...
  function Dt(e, t) {
    return Array.isArray(e) && it(e[0])
      ? e.concat(t)
      : Array.isArray(t) && it(t[0]) && it(e)
      ? [e, ...t]
      : Array.isArray(t)
      ? t
      : void 0
  }
  function Bt(e, { config: t, base: r, path: n, reference: o }) {
    let a = []
    ...
    for (let a of t.presets ?? [])
      Bt(e, { path: n, base: r, config: a, reference: o })
    for (let t of a)
      e.plugins.push(t),
        t.config &&
          Bt(e, {
  ...
  function Lt({ addVariant: e, config: t }) {
        ...
        if ("@plugin" === e.name) {
          ...
          for (let t of e.nodes ?? []) {
            ...
            let e = R(t.value, ",").map(e => {
              ...
              if ("{" === e[0] && "}" === e[e.length - 1])
                throw new Error(
                  `Unexpected \`@plugin\` option: Value of declaration \`${C([
                    t,
  ...
  function qt({
    ...
    let i = 0,
      ...
      { resolvedConfig: s } = Ut(e, [
        { config: Ft(e.theme), base: t, reference: !0 },
        ...l,
        { config: { plugins: [Lt] }, base: t, reference: !0 },
      ]),
      { resolvedConfig: c, replacedThemeKeys: u } = Ut(e, l),
    ...
    let f,
      ...
      h = bt({ ...p, referenceMode: !1 })
    for (let { handler: e, reference: t } of s.plugins)
      t ? ((f ||= bt({ ...p, referenceMode: !0 })), e(f)) : e(h)
    if (
      (tt(e, c, u),
      zt(e, c),
      (function (e, t) {
  ...
  async function Jt(
    e,
    { base: t = "", loadModule: r = Yt, loadStylesheet: n = Gt } = {},
  ) {
    let i = 0
    ;(e = [$({ base: t }, e)]), (i |= await Qe(e, t, n))
    let l = null,
      c = new s(),
      u = [],
      d = [],
      ...
      if ("at-rule" === e.kind) {
                          ...
                          if (
                            ...
                            console.warn(
                              `Unsupported bare value data type: "${
                                t.value
                              }".\nOnly valid data types are: ${Ce.map(
                                e => `"${e}"`,
                              ).join(", ")}.\n`,
                            )
                            let r = t.value,
        ...
        if ("@source" === e.name) {
          ...
          if (a) {
            let e = o ? T : j,
              t = R(l, " ")
            for (let r of t) for (let t of Ht(r)) e.push(t)
  ...
  async function Xt(e, r = {}) {
    let n = t(e),
      o = await (async function (e, t = {}) {
        ...
        n.unshift(
          x("! tailwindcss v4.1.4 | MIT License | https://tailwindcss.com "),
        )
        let u = new Set(),
          d = null,
          f = 0,
        ...
        return {
          ...
          build(o) {
            ...
            let m = Pe(u, r, { onInvalidCandidate: c }).astNodes
            return s || f !== m.length
              ? ((f = m.length), (i.nodes = m), (d = T(n, r, t.polyfills)), d)
  ...
  async function sr(e, t) {
    try {
      let r = (function () {
        if ("tailwindcss" === e) return { base: t, content: Qt.index }
        if (
          "tailwindcss/preflight" === e ||
          "tailwindcss/preflight.css" === e ||
          "./preflight.css" === e
        )
          return { base: t, content: Qt.preflight }
        if (
          "tailwindcss/theme" === e ||
          "tailwindcss/theme.css" === e ||
          "./theme.css" === e
        )
          return { base: t, content: Qt.theme }
        if (
          "tailwindcss/utilities" === e ||
          "tailwindcss/utilities.css" === e ||
          "./utilities.css" === e
        )
          return { base: t, content: Qt.utilities }
        throw new Error(`The browser build does not support @import for "${e}"`)
      })()
      return (
        lr.hit("Loaded stylesheet", { id: e, base: t, size: r.content.length }),
        r
      )
    } catch (r) {
      throw (
        (lr.hit("Failed to load stylesheet", {
          id: e,
          base: t,
          error: r.message ?? r,
        }),
        ...
        lr.start(`Build #${t} (${e})`),
          ...
          await (async function (e) {
            ...
            for (let e of document.querySelectorAll("[class]"))
              for (let r of e.classList) rr.has(r) || (rr.add(r), t.add(r))
            lr.end("Collect classes", { count: t.size }),
              (0 !== t.size || "incremental" !== e) &&
                (lr.start("Build utilities"),
                (or.textContent = er.build(Array.from(t))),
                lr.end("Build utilities"))
          })(e),
          lr.end("Build"),
          lr.end(`Build #${t} (${e})`)
      })
  ...
  var dr = new MutationObserver(() => ur("full"))
  function fr(e) {
    dr.observe(e, {
      attributes: !0,
    ...
    for (let n of e) {
      for (let e of n.addedNodes)
        e.nodeType === Node.ELEMENT_NODE &&
          ...
          (fr(e), t++)
      for (let e of n.addedNodes) 1 === e.nodeType && e !== or && r++
      "attributes" === n.type && r++
    }
